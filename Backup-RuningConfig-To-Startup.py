...
def bkp_run_to_startup(net_connect):
    ...
    if 'Destination filename' in SaveRunToStart:
        ...
        PushCommand02 = net_connect.send_command('show startup-config')
        for line in PushCommand02.splitlines(): # Search for the keyword & print the entire line.
            if "Last configuration change at" in line:
                print (line)
                break

device = ['10.204.5.13'] #List of devices IP.
